...
const KEY_OPENCODE_NOTIFICATIONS = "opencodeNotifications";
...
export async function loadPreferences(): Promise<Preferences> {
  ...
  return {
    ...
    opencodeNotifications:
      get<boolean>(KEY_OPENCODE_NOTIFICATIONS) ??
      DEFAULT_PREFERENCES.opencodeNotifications,
    shortcuts:
...
export async function setSftpTabVisible(value: boolean): Promise<void> {
...
export async function setOpencodeNotifications(value: boolean): Promise<void> {
  await writePref(KEY_OPENCODE_NOTIFICATIONS, value);
}
...
export async function onPreferencesChange(
  ...
  const map: Record<string, PrefKey> = {
    ...
    [KEY_OPENCODE_NOTIFICATIONS]: "opencodeNotifications",
